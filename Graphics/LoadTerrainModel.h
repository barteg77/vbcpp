...
class TerrainLoader
{
    ...
    private:
        ...
        static RStaticModel* loadTerrainFromHeightmap(const char* heightmapPseudoId, std::string materialPseudoId, std::string materialName, std::string texturePath, float maxHeight, bool is16bit);
