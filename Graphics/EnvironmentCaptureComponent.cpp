...
void EnvironmentCaptureComponent::initIrradianceFramebufferAndShader()
{
	...
	_irradianceShader = ResourceManager::getInstance().loadResource<RShader>(ResourceId::create<RT_SHADER>("Shaders/pbr/irradiance.vert", "Shaders/pbr/irradiance.frag"));
	...
	_prefilterEnvMapShader = ResourceManager::getInstance().loadResource<RShader>(ResourceId::create<RT_SHADER>("Shaders/pbr/irradiance.vert", "Shaders/pbr/prefilterEnvironment.frag"));
